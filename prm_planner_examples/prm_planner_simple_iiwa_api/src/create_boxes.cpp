...
int main(int argc,
		char** argv)
{
	ros::init(argc, argv, "iiwa_two_boxes");
	ros::NodeHandle n;
	...
	o1.transformation.transform.translation.y = 0.0;
	o1.transformation.transform.translation.z = 0.35;
	...
	{	0.8, 0.3, 0.5};
	o1.transformation.transform.translation.x = 1.0;
	o1.transformation.transform.translation.y = 0;
	o1.transformation.transform.translation.z = 1.2;
	o1.transformation.transform.rotation.w = 1.0;
	o1.transformation.transform.rotation.x = 0.0;
	o1.transformation.transform.rotation.y = 0.0;
	o1.transformation.transform.rotation.z = 0.0;
